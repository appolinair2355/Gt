...
class SessionManager:
    ...
    def _init_database(self):
        ...
        try:
            # Importer et exécuter la configuration automatique
            ...
            if not db_connected:
                logger.error("❌ Test de connexion base de données échoué")
                return None

            # Configuration automatique des tables
            setup_success = loop.run_until_complete(setup_render_database())
            if not setup_success:
                logger.error("❌ Configuration automatique base de données échouée")
                return None
            ...
            logger.info("✅ Session database initialisée avec configuration automatique")
